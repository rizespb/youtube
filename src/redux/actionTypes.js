...
export const SELECTOR_VIDEO_REQUEST = 'SELECTOR_VIDEO_REQUEST'
export const SELECTOR_VIDEO_SUCCESS = 'SELECTOR_VIDEO_SUCCESS'
export const SELECTOR_VIDEO_FAIL = 'SELECTOR_VIDEO_FAIL'
